...
namespace Autoglass.PlataformaHUB.Domain.Configuracoes
{
    ...
    public static class CatalogoServicos
    {
        ...
        public static IReadOnlyList<DefinicaoServico> ServicosProvisionamento =>
            _todos.Where(d => d.EhProvisionamento).ToList();
        ...
        public static IReadOnlyList<DefinicaoServico> ServicosInfraestrutura =>
            _todos.Where(d => d.EhProvisionamentoInfraestrutura).ToList();
        ...
        private static IEnumerable<DefinicaoServico> ConstruirCatalogo()
        {
            ...
            yield return Criar(
                ...
                horasPorUnidade: 6m, ehProvisionamento: true, ehInfraestrutura: true,
                especificacoes: new[]
                {
            ...
            yield return Criar(
                ...
                horasPorUnidade: 7m, ehProvisionamento: true, ehInfraestrutura: true);
            ...
            yield return Criar(
                ...
                horasPorUnidade: 4m, ehProvisionamento: true,
                especificacoes: new[]
                {
            ...
            yield return Criar(
                ...
                rotuloPrincipal: "Provisionamentos no período",
                chavesPrincipais: new[] { ChaveMetricaEnum.ProvisionamentosQuantidade },
                horasPorUnidade: 2.5m, ehProvisionamento: true);
            ...
            yield return Criar(
                ...
                rotuloPrincipal: "Provisionamentos no período",
                chavesPrincipais: new[] { ChaveMetricaEnum.ProvisionamentosQuantidade },
                horasPorUnidade: 5m, ehProvisionamento: true, ehInfraestrutura: true);
            ...
            yield return Criar(
                ...
                horasPorUnidade: 10.5m, ehProvisionamento: true,
                especificacoes: new[]
                {
            ...
            yield return Criar(
                ...
                horasPorUnidade: 12m, ehProvisionamento: true,
                especificacoes: new[]
                {
            ...
            yield return Criar(
                ...
                rotuloPrincipal: "Provisionamentos no período",
                chavesPrincipais: new[] { ChaveMetricaEnum.ProvisionamentosQuantidade },
                horasPorUnidade: 4.5m, ehProvisionamento: true, ehInfraestrutura: true);

            yield return Criar(
                ContextoMetricaEnum.Liquibase, CategoriaServicoEnum.Dev,
                rotuloPrincipal: "Provisionamentos no período",
                chavesPrincipais: new[] { ChaveMetricaEnum.ProvisionamentosQuantidade },
                horasPorUnidade: 5.5m, ehProvisionamento: true, ehInfraestrutura: true);
            ...
            yield return Criar(
                ...
                horasPorUnidade: 8m, ehProvisionamento: true,
                especificacoes: new[]
                {
        ...
        private static DefinicaoServico Criar(
            ...
            bool ehProvisionamento = false,
            bool ehInfraestrutura = false,
            IReadOnlyList<EspecificacaoServico>? especificacoes = null)
        {
            return new DefinicaoServico
            {
                ...
                EhProvisionamento = ehProvisionamento,
                EhProvisionamentoInfraestrutura = ehInfraestrutura,
